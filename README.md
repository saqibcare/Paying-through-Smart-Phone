We are living in a technology oriented world where millions of money is
...
mobile app development, we have number of providers and number or
platforms which are still growing. The objective of this paper is to
explore the history and future of mobile payment along with the API’s
provided by different vendors. This report is generated by exploring
different researches and documentation provided over internet.
Explanation is given with the help of developing a demo application with
mobile payment capability. The findings of this report will give better
understanding to software developers in term of choosing the mobile
payment service developed by different third parties. Conclusion tells,
that the paper will provide vast explanatory explanation with a
...
money in exchange of services or products. Mobile payment can also be
used to send or receive of money to your friends and family. Mobile
payment is gradually growing technology with a tremendous rate because
almost all the financial institutions around the globe are adapting the
mobile technology for the debit and credit of money belong to their
customers. Most of the Bank have introduced different mobile application
for their customer, through which they can perform online transactions
from their hand held devices. What is Mobile wallet :- Mobile wallet is
basically a digital wallet, all you need is to download the mobile
wallet app into you mobile phone and add your credit card information.
No after the authentication you are authorize to make payment through
mobile without the involvement of hard cash or cheques. The technology
which will allow mobile wallet to perform transaction is called NFC
(near field communication). NFC is a technology which enable your mobile
to communicate with payment reader to perform the payment. Example are
Apple Pay or Samsung Pay. What is mobile money transfer? this is
basically a payment method in which we transfer money through some
mobile application or third party service integrated in some application
to some business or person. Examples are PayPal or wechat. Lets move
forward to see some statistics related to mobile development.

Statistical Data
================

Here we will discuss about statistics about multiple researches carried
out in term of examining the mobile payment market.

Statistics of Global Mobile Payment Spending
--------------------------------------------

According to the study that has been published by Goldman Sachs in the
year of 2013 show the bright future of mobile payment technology with
...
As you can see the Global market overview in the fig 1.1 in which it is
...
options that in where area, users spend more money in mobile technology.
we can see the study covers merchandise purchases, Ticketing, Money
transfer, bill payments, airtime top-ups and other spending. But most of
the users were bend towards merchandise purchases and money transfers.
This case study show the statistics in the 2013 but it shows the future
till 2017, despite of all the dates mentioned here, today in 2019, we
have much more money has been spent by the users all around the world
and this is still growing and expanding.

Mobile Money
------------

Mobile Money is the future of the modern world , where not only you
money but everything is going to be shift on your hands. Here we need to
consider one thing that These technologies cannot unless the government
of that particular area support it. Now a days Government are also
moving towards the E-Governance therefore they encourage the steps taken
for the technological enhancement. Here we will explain this scenario
with figure how this technology is attracting people towards it self.

![image](mobile)

The given fig is also taken form the “Goldman Sach” research which is
clearly representing the scenario of today’s Mobile technology growth.
As we can clearly see that how the Mobile money is distributed in
different channels and how users are interacting with those channels to
fulfill their need in terms of Mobile payment technology. Here we are
going to explain all the topics one by one.

### Mobile Banking

Mobile Banking is Present and future trend for all of the financial
institutions. Now a days every user want to control all of his
belongings with the mobile or device which is in his hand. Bank Account
of the user will be top of the list, where user really want to have a
...
also save the time by going to bank and follow different steps just to
perform one transaction. Therefore most of the banks have been
introduced the mobile banking, because they also don’t want to loose
...
mobile money is used within the businesses to carryout different tasks
...
which the user pay against the service or goods. Almost all of the
e-commerce websites are providing the mobile payment methods otherwise
they will loose the users. Because most of the users are dependent on
the mobile payment.
...
Here is the fig which is going to give the overviews of the users
...
payments. It is showing you the number of user in millions around the
world who are using different mobile payment platform to perform the
...
the top rated giants and are covering most of the users around globe,
but the others want to stay and compete into the market with these
...
Lets talk about the future of mobile payment technology. As we already
discuss about some research studies from the past year which were
showing current market span of this technology. Now it’s time that we
...
current scenario and past growth rate. The final value was taken as a
sixty percent of CACR (compound annual growth rate). This is the reason
this technology has very bright future ahead. Market span of mobile
payment technology is in billions that’s why this technology has worth
to stand besides other giant technology in the scientific world.

Rapid growth of mobile payment technology vendors
-------------------------------------------------

As the worth of mobile payment technology is increasing, therefore
stakeholders of technological world are also wanted to be updated
...
themselves then they will loose the competition against other market
giants.

![image](vendors)

Here in the fig 4 you can see that, we have multiple options to use the
services of mobile payment, because vendors are greater in number.
Almost all the top brand are in the list. Which is a clear example that
...
market. If a business wants to stay in the market then it needs to
compete with its competitors and provide the product which are according
to the customer need. I am taking the example of NOKIA failure. Nokia
was the market giant in the smart phone industry till 2007 but after the
launch of IPHONE and ANDROID, Nokia market shares starts decreasing till
the company CEO announce that “We do nothing but we loose”@nokia. why
they loose the competition with the competitors because they did not
follow the market trends to provide a nice User Experience. Therefore it
is important for every business to keep itself updates with the latest
...
We have discuss about the evolution of mobile payment technology, now we
...
account with your PayPal account as well, this is very famous in user
because of it’s ease of use. You can say that it act as an virtual
...
allow you to pay through PayPal, because PayPal provide any easy support
and free of cost for the developer to incorporate their services in
there website without any extra cost. Here are some facilities which are
covered by PayPal@PayPalAgreement:-

1.  Send or receive payments for online actions at eBay and other
    website.

2.  Purchase and sell of goods and service.
...
format for the Api’s. Let’s explain the whole process of transaction
execution with the help of diagram@PayPal.

Fig 5 which is given below, shows how a transaction executes in the
PayPal case. First of all your site makes request to the PayPal Api to
make the desired amount of payment transaction. After verifying that
request, in response to that call to the Paypal, user will be redirected
to the login page of the Paypal. Now user need to provide the
credentials on for the Paypal account in order to make the transaction
successful. When user press the login button after the user email and
password, PayPal will confirm that whether any user with the given email
and password exist or not. If Paypal Confirm the authentication’s, the
...
recharge your account. If your account have the enough money which is
required for the transaction then your will be asked to confirm the
payment and upon the confirmation of successful transaction, you got
message on the requesting site screen@paypalJornal.
...
website or any other kind of software where money is involve. Here we
...
Sandbox account, Then you need you register your application in the
